# patch_sheet_height.py
import io

# --- 1. index.html: фиксированная высота панели ---
HTML = "index.html"
...
# cache-bust v10 -> v11
old_js = r"""document.write('<script src="app-v10.js?v=' + v + '&x=6"><\/script>');"""
new_js = r"""document.write('<script src="app-v11.js?v=' + v + '&x=7"><\/script>');"""
...
# --- 2. app-v11.js: центрированный empty state ---
JS = "app-v11.js"
...
assert old_empty in js, "empty state not found"
